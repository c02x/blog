...
import com.shanzhu.blog.cms.domain.*;
import com.shanzhu.blog.cms.service.*;
...
public class ChartController extends BaseController {
    ...
    public Map lineChart() {
        ...
        cmsComment.setDelFlag("0");
        commentData.add(chartService.selectCmsCommentListBetweenCreateTime(cmsComment, sf.format(MonBegin),
                sf.format(MonEnd)).size());
        commentData.add(chartService.selectCmsCommentListBetweenCreateTime(cmsComment, sf.format(TueBegin),
                sf.format(TueEnd)).size());
        commentData.add(chartService.selectCmsCommentListBetweenCreateTime(cmsComment, sf.format(WedBegin),
                sf.format(WedEnd)).size());
        commentData.add(chartService.selectCmsCommentListBetweenCreateTime(cmsComment, sf.format(ThuBegin),
                sf.format(ThuEnd)).size());
        commentData.add(chartService.selectCmsCommentListBetweenCreateTime(cmsComment, sf.format(FriBegin),
                sf.format(FriEnd)).size());
        commentData.add(chartService.selectCmsCommentListBetweenCreateTime(cmsComment, sf.format(SatBegin),
                sf.format(SatEnd)).size());
        commentData.add(chartService.selectCmsCommentListBetweenCreateTime(cmsComment, sf.format(SunBegin),
                sf.format(SunEnd)).size());
        cmsMessage.setDelFlag("0");
        messageData.add(chartService.selectCmsMessageListBetweenCreateTime(cmsMessage, sf.format(MonBegin),
                sf.format(MonEnd)).size());
        messageData.add(chartService.selectCmsMessageListBetweenCreateTime(cmsMessage, sf.format(TueBegin),
                sf.format(TueEnd)).size());
        messageData.add(chartService.selectCmsMessageListBetweenCreateTime(cmsMessage, sf.format(WedBegin),
                sf.format(WedEnd)).size());
        messageData.add(chartService.selectCmsMessageListBetweenCreateTime(cmsMessage, sf.format(ThuBegin),
                sf.format(ThuEnd)).size());
        messageData.add(chartService.selectCmsMessageListBetweenCreateTime(cmsMessage, sf.format(FriBegin),
                sf.format(FriEnd)).size());
        messageData.add(chartService.selectCmsMessageListBetweenCreateTime(cmsMessage, sf.format(SatBegin),
                sf.format(SatEnd)).size());
        messageData.add(chartService.selectCmsMessageListBetweenCreateTime(cmsMessage, sf.format(SunBegin),
                sf.format(SunEnd)).size());
